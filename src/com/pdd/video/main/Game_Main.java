...
import com.pdd.video.Crawler.huyaGameCrawlerLink;
import com.pdd.video.Crawler.huyaGameCrawlerTag;
...
public class Game_Main {
	public static void main(String[] args) {
		try {
			List<urlBase> TVUrls=huyaGameCrawlerLink.getLinks();
			for (urlBase urlBase : TVUrls) {
				pageBase page=huyaGameCrawlerTag.getPage(urlBase);
