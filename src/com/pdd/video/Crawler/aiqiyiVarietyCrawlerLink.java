...
public class aiqiyiVarietyCrawlerLink {
	...
	private static String CrawlerUrls[][]={
		{"http://list.iqiyi.com/www/6/-------------11-%d-1-iqiyi--.html","综艺"},
		{"http://list.iqiyi.com/www/22/-------------11-%d--iqiyi--.html","搞笑"},
	};
	/**
	 * 获取链接
	 */
	...
	public static List<urlBase> SetProp(Elements els,String MainType){
		...
		for (Element e : els) {
			...
			if(!e.select("div.site-piclist_pic a p.viedo_lt ").isEmpty()){
				continue;//过滤Vip电影
			}
