...
public class aiqiyiComicCrawlerLink {
	...
	private static String CrawlerUrls[][]={
		{"http://list.iqiyi.com/www/4/----------0---11-%d-1-iqiyi--.html","动漫"},
	};
	/**
	 * 获取链接
	 */
	...
	public static List<urlBase> SetProp(Elements els,String MainType){
		...
		for (Element e : els) {
			...
			if(base.getTitle().equals("蜡笔小新")||
					base.getTitle().equals("名侦探柯南 普通话")||
					base.getTitle().equals("猫和老鼠全集")||
					base.getTitle().equals("熊出没之冬日乐翻天")||
					base.getTitle().equals("爆笑虫子全集")||
					base.getTitle().equals("最强战士之迷你特工队")||
					base.getTitle().equals("熊出没全集")||
					base.getTitle().equals("妖神记")||
					base.getTitle().equals("迪迦奥特曼")||
					base.getTitle().equals("王者歪传")||
					base.getTitle().equals("熊出没之探险日记")||
					base.getTitle().equals("一人之下 第2季")
			){
				continue;
			}
...
//			base.setDuration(e.select("div.site-piclist_pic div.wrapper-listTitle p.viedo_rb").text());//电视剧无时长
	...
	public static void main(String[] args) {
		...
		for (urlBase u : AllUrl) {
			...
			System.out.println("源站链接:"+u.getMainTypeStr());
			System.out.println("");
		}
	}
}
